...
authorised_addresses = ["fxap.home", "fxap.local", "pimin.home", "pimin.local", "25.110.219.165", "Xav'sPad", "snail.local"]
...
class Comms (threading.Thread):
		...
		while True:
			...
			if client_socket is None: #or test_conn == False:
                                print "Client %s disconnected" % host
                                break
